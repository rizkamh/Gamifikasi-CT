				...
				<form class="form-horizontal" action="" id="form2" name="form2">
					<div class="control-group">
						...
						<div class="controls" id="val1">
							<input id="kirprodi" name="kirprodi" class="form-control" value="TI" type="hidden">
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls" id="val3">
							<input type="hidden" id="tipetugas" name="tipetugas" class="form-control" value="tugas">
			...
			<div class="widget-box">
				...
				<div class="widget-content nopadding">
					...
					<form action="" id="form1" name="form1" class="form-horizontal" enctype="multipart/form-data">
						...
						<div class="control-group">
							<label class="control-label"><strong>Level Soal</strong></label>
							<div class="controls">
