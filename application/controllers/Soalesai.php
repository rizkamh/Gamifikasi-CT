...
class Soalesai extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('pertanyaan/soalesai_view', $data);
	}
	...
	public function kirimsoal(){
		// if($this->_validate2()){
			$mhs = json_encode($this->pertanyaan_model->getmahasiswa($this->input->post("kirsem"))->result());
			$temp = count($this->pertanyaan_model->getmahasiswa($this->input->post("kirsem"))->result());
