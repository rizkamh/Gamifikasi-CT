...
function klikstart() {
	...
	if (tp == "Essai") {
		...
		for (let i = 0; i < ol.length; i++) {
			...
			input[i] = "<input class='del' type='hidden' name='tanya" + i + "' id='tanya" + i + "'>";
			$('#form2').append(input[i]);
			$('#form2').append("<input class='del' type='hidden' name='nomor" + i + "' id='nomor" + i + "' value='" + $('#nopilgan' + i).val() + "'>");
			$("#tanya" + i).val(tanya[i]);
		...
		success: function (data) {
			...
			for (i = 0; i < 1; i++) {
				...
				html += "<table class='fontsoal' style='width:500px; font-size:15px;'>" +
					...
					"<tr>" +
					"<td><strong>Point Soal : " + data[i].nilai + "</strong></td>" +
					"</tr>" +
					"</table>" +
					"<hr>";
			}
		...
		success: function (data) {
			...
			for (i = 0; i < data.length; i++) {
				...
				html +=
					...
					"<blockquote id='jwb_" + i + "'><ol start='1' type='A' data-id='" + data[i].idsoalpil + "'>" +
					"<input type='hidden' id='nopilgan" + i + "' value='" + data[i].nopilgan + "' />" +
					"<div class='form-inline' style='margin-top:15px;'><label for='radioa" + i + "'> <li id='lia" + i + "'><input type='checkbox' name='radioa" + i + "' id='radioa" + i + "' style='margin-bottom:5px;' value='A'><span class='ra" + i + "'>" + a + "</span></li> </label> </div>" +
					"<div class='form-inline' style='margin-top:15px;'><label for='radiob" + i + "'> <li id='lib" + i + "'><input type='checkbox' name='radiob" + i + "' id='radiob" + i + "' style='margin-bottom:5px;' value='B'><span class='rb" + i + "'>" + b + "</span></li> </label> </div>" +
					"<div class='form-inline' style='margin-top:15px;'><label for='radioc" + i + "'> <li id='lic" + i + "'><input type='checkbox' name='radioc" + i + "' id='radioc" + i + "' style='margin-bottom:5px;' value='C'><span class='rc" + i + "'>" + c + "</span></li> </label> </div>" +
					"<div class='form-inline' style='margin-top:15px;'><label for='radiod" + i + "'> <li id='lid" + i + "'><input type='checkbox' name='radiod" + i + "' id='radiod" + i + "' style='margin-bottom:5px;' value='D'><span class='rd" + i + "'>" + d + "</span></li> </label> </div>" +
					"</ol></blockquote>" +
					"<br>";
			}
			$("#form1").html(html);
		...
		success: function (data) {
			...
			for (i = 0; i < data.length; i++) {
				if (data[i].status == 'belum') {
					html += "<tr>" +
						"<td class='taskDesc'><i class='icon-info-sign alert-danger'></i>Quiz " + (i + 1) + " </td>" +
					...
					html += "<tr>" +
						"<td class='taskDesc'><i class='icon-info-sign alert-info'></i>Quiz " + (i + 1) + " </td>" +
						"<td class='taskDesc'><i class='icon-info-sign'></i> Tipe Soal : " + konversiTipesoal(data[i].tipesoal) + "</td>" +
						"<td class='taskStatus'>" + data[i].tanggal + "</td>" +
						"" + Statustampil(data[i].status) + "" +
